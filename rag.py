...
def generate_with_gemini(context: str, question: str) -> str:
    ...
    """
    prompt = f"""
Sen bir lise öğretmenisin. Aşağıdaki konu bilgisine göre, öğrencinin sorusuna doğrudan konuyu açıklayarak başla. Yanıtında selamlama, iyi dilekler veya sohbeti devam ettirme amacı taşıyan ifadeler kullanma. Açıklaman basit ve net olsun.
